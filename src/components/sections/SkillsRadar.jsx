        ...
        <ScrollReveal delay={0.2}>
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  boxShadow: selectedSkill >= 0
                    ...
                    : '0 0 60px rgba(224,31,55,0.05), 0 0 120px rgba(26,74,122,0.08)',
                    ...
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                        <div style={{
                          ...
                          <activeDetail.Icon size={24} color={activeDetail.color} />
                        </div>
                        <div>
                          <h3 style={{
                            fontSize: '1.2rem',
                    ...
                    <div style={{ padding: '28px 32px' }}>
                      ...
                      <div style={{ marginBottom: '24px' }}>
                        <div style={{
                          ...
                          <span style={{ fontSize: '0.75rem', color: '#7a9abb' }}>
                            Proficiency
                          </span>
                          <span style={{
                            fontSize: '1rem',
                        ...
                        <div style={{
                          ...
                          <div style={{
                            ...
                            boxShadow: `0 0 10px ${activeDetail.color}40`,
                          }} />
                        </div>
                      </div>
                      ...
                      <div style={{
                        ...
                        <div style={{
                          ...
                          <p style={{ fontSize: '0.6rem', color: '#7a9abb', marginBottom: '4px' }}>
                            Experience
                          </p>
                          <p style={{ fontSize: '0.85rem', fontWeight: 700, color: '#f0ece3' }}>
              ...
              {/* Tech quote when no skill selected */}
{selectedSkill < 0 && (
  <div style={{
    maxWidth: '500px',
    textAlign: 'center',

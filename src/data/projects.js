const projects = [
  ...
  },
  {
    ...
    longDescription:
      "Built with Next.js, Tailwind CSS and WebGL effects. Features smooth scroll, animated sections and Nodemailer contact form.",
  ...
  },
  {
    ...
    longDescription:
      "Built with html. Features personalized recommendations, category filtering and user-friendly interface.",
